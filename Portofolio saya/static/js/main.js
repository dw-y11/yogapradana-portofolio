...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const sections = document.querySelectorAll('.panel'); // Adjusted for redesigned layout
    ...
    // ---------- SKILL BAR ANIMATION ----------
    // Note: uses .skill-editorial-progress in high-end design
    const skillBars = document.querySelectorAll('.skill-editorial-progress, .skill-progress');
